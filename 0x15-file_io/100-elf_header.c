...
/**
 * check_elf - function checks for elf file
 * @e_ident: array containing elf numbers
 * Return: exit if not elf file
 */
...
/**
* print_magic - function prints magic numbers
* @e_ident: arrayof magic numbers
* Return: separe magic number with spaces
*/
...
/**
* print_osabi - function prints OS/ABI of ELF
* @e_ident: array of elf version
*/
...
* @e_ident: array of abi version of elf
*/
...
/**
* print_type - function prints type of elf
